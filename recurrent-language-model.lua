...
cmd:option('--trainsize', 4096, 'number of train examples seen between each epoch')
cmd:option('--validsize', 2048, 'number of valid examples used for early stopping and cross-validation') 
cmd:option('--savepath', './char_results', 'path to directory where experiment log (includes model) will be saved')
cmd:option('--id', 'althingi_lstm_with_txtutil', 'id string of this experiment (used to name output file) (defaults to a unique id)')
